...
function Editor (props) {
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      github: activeInfo?.details
        ...
        leetcode: activeInfo?.details
        ? activeInfo.details[0]?.leetcode || ""
        : activeInfo?.detail?.leetcode || "",
  ...
  useEffect(() => {
    ...
    setValues({
      ...
      leetcode: activeInfo.details[activeDetailIndex]?.leetcode || "",
